    ...
    <>
      <Box
        sx={{
          ...
          boxShadow:
            boxShadow ||
            `rgba(0, 128, 0, 0.15) 0px 30px 30px, rgba(0, 128, 0, 0.08) 0px -8px 20px, rgba(0, 128, 0, 0.08) 0px 2px 4px, rgba(0, 128, 0, 0.12) 0px 8px 10px, rgba(0, 128, 0, 0.05) 0px -2px 3px`,
      ...
      <Box
        ...
        sx={{
          ...
          p: 0.5,
          borderRadius: "10px",
          boxShadow:`4px 3px 1px ${gloabalTheme.colors.primary}`,
        }}
      >
        <div className="bg-transparent">
          <h2 className="text-sm font-semibold text-left">{jobTypes.title}</h2>
        </div>
        <div className="mt-10 pb-3">
          <button
            type="button"
            className="shadow-xl p-1 rounded-md text-[15px] text-white"
