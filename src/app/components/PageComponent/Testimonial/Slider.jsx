          ...
          {extendedTestimonials.map((testimonial, index) => (
            <Box
              ...
              sx={{
                ...
                transform:
                  currentSlide === index ? "scale(0.95)" : "scale(0.90)",
                ...
                sx={{
                  ...
                  boxShadow:
                    currentSlide === index
                      ...
                      : "none",
                  "&:hover": {
                    borderTop: `10px solid ${gloabalTheme.colors.primary}`,
                    borderLeft: `4px solid ${gloabalTheme.colors.primary}`,
                    borderRight: `4px solid ${gloabalTheme.colors.primary}`,
                    borderRadius: "10px",
                    padding:'20px'
                  },
                }}
