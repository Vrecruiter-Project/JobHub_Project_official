...
const CategoriesSection = () => {
    ...
    const category = [
        { title: "Cold Calling Telecaller" },
        { title: "Lead Generation Telecaller" },
        { title: "Back Office Executive" },
        { title: "Outbound Sales Telecaller" },
        { title: "Telemarketing Telecaller" },
    ]
    return (
        <>
            <Box sx={{
                    ...
                    <Grid2 container sx={{
                        ...
                        <Grid2 item xs={12} md={12}>
                            <Typography variant="h3" component="h2" sx={{
                                ...
                                Explore By More Specific <span style={{ color: "green" }}> Categories</span>
                            </Typography>
                        </Grid2>
                    </Grid2>
                    <Grid2 container sx={{
